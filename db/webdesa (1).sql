...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2022 at 06:25 AM
...
INSERT INTO `album` (`id_album`, `judul`, `id_kat`) VALUES
(2, 'A', 2),
(3, 'm', 2);
...
INSERT INTO `aparat` (`pamong_id`, `id`, `pamong_nama`, `pamong_nip`, `pamong_nik`, `jabatan`, `pamong_tgl_terdaftar`, `pamong_ttd`, `foto`, `pamong_tempatlahir`, `pamong_tanggallahir`, `pamong_sex`, `pamong_pendidikan`, `pamong_agama`, `pamong_nosk`, `pamong_tglsk`, `pamong_pangkat`, `pamong_nipd`) VALUES
(10, 12, 'Arie Rukmana', '2', '3332323232', '2', NULL, NULL, '', 'c', '2022-02-16', '1', '1', '1', '2', '2022-02-21', '2', '2');
...
INSERT INTO `bantuan` (`id_program`, `nama_program`, `asaldana`, `sasaran`, `tgl1`, `tgl2`, `status`, `keterangan`) VALUES
(5, 'A', 2, 1, '2022-03-02', '2022-02-21', 1, 'A');
...
INSERT INTO `budaya` (`id_budaya`, `judul`, `id_kat`, `link`, `tipe`, `data`, `tgl_posting`, `slug`, `isi`) VALUES
(2, 'A', 2, 0, 1, 'File Explorer 11_7_2021 8_09_29 PM.png', '2022-02-01 14:20:08', 'A-', '<p>ghghg</p>\r\n');
...
INSERT INTO `dokumen` (`id_dokumen`, `id`, `id_syarat`, `nama_dokumen`, `slug`, `file`) VALUES
(7, 12, 1, 'RT', 'rt', 'download.jpg'),
(8, 12, 2, 'KK', 'kk', 'infografis-badai-sitokin-pada-covid-19-1.jpeg'),
(10, 13, 1, 'Surat Pengantar ', 'surat-pengantar', 'ss.png'),
(11, 13, 2, 'FC KK', 'fc-kk', 'shutterstock_140702578.jpg'),
(12, 12, 3, 'KTP', 'ktp', 'Untitled.png');
...
INSERT INTO `dusun` (`id_dusun`, `namadusun`, `kepala_dusun`) VALUES
(18, 'Dusun Cikandung', 'c');
...
INSERT INTO `identitas` (`id`, `nama_desa`, `kode_desa`, `nama_kepala_desa`, `nip_kepala_desa`, `kode_pos`, `nama_kecamatan`, `kode_kecamatan`, `nama_kepala_camat`, `nip_kepala_camat`, `nama_kabupaten`, `kode_kabupaten`, `nama_propinsi`, `kode_propinsi`, `logo`, `map`, `alamat_kantor`, `email_desa`, `telepon`, `website`, `kantor_desa`) VALUES
(1, 'Cikand', '05', 'A', '12', '4', 'Cimalaka', '45', 'Ar', '154', 'Sumedang', '4', 'Jawa Barat', '6545', '', 'sumedang', 'sum', 'asep@gmail.com', '084', 'www.desa', '');
...
INSERT INTO `kat_album` (`id_kat`, `kategori`) VALUES
(2, 'Album 1');
...
INSERT INTO `kat_budaya` (`id_kat`, `kategori`) VALUES
(2, 'Album 1');
...
INSERT INTO `kat_umkm` (`id_kat`, `kategori`) VALUES
(2, 'Kelompok Ternak');
...
INSERT INTO `kk` (`id_kk`, `id`, `no_kk`) VALUES
(1, 12, '1212123131313111');
...
INSERT INTO `pendaftar` (`id_pendaftar`, `id`, `nik`, `pin`, `tgl_buat`, `status`) VALUES
(2, 12, '3', '96e79218965eb72c92a549dd5a330112', '2022-02-08', 1),
(5, 13, '2', 'fb62579e990da4e2a8f15c3d1e123438', '2022-02-08', 1);
...
INSERT INTO `penerima` (`id_penerima`, `id_program`, `id`, `no_peserta`, `foto`) VALUES
(5, 5, 12, '1212121212', '4-aksi-nyata-menuju-indonesia-sehat.jpg');
...
INSERT INTO `permohonan_surat` (`id_permohonan`, `id`, `id_surat`, `status`, `created`, `updated`) VALUES
(1, 12, 15, 4, '2022-02-12', '2022-02-12'),
(2, 12, 17, 4, '2022-02-13', '2022-02-13');
...
INSERT INTO `rt` (`id_rt`, `rt`, `id_dusun`, `id_rw`, `kepala_rt`) VALUES
(6, '01', 18, 13, ''),
(7, '02', 18, 13, ''),
(8, '03', 18, 13, '');
...
INSERT INTO `rw` (`id_rw`, `rw`, `id_dusun`, `kepala_rw`) VALUES
(13, '001', 18, ''),
(14, '002', 18, ''),
(15, '003', 18, ''),
(16, '004', 18, '');
...
INSERT INTO `setting_web` (`id_setting`, `nama`, `file`) VALUES
(10, 'Kepala Desa', 'NC1ha3NpLW55YXRhLW1lbnVqdS1pbmRvbmVzaWEtc2VoYXQuanBn');
...
INSERT INTO `sosmed` (`id`, `fb`, `wa`, `ig`, `yt`, `twitter`, `telegram`) VALUES
(7, 'www.facebook.com\r\n', '', '', '', '', '');
...
INSERT INTO `surat_format` (`id_format_surat`, `nama_surat`, `url_surat`, `url_kades`, `url_admin`, `url_download`, `kode_surat`, `lampiran`, `kunci`, `favorit`, `jenis`, `mandiri`, `masa_berlaku`, `satuan_masa_berlaku`, `qr_code`) VALUES
(1, 'Keterangan Pengantar', 'surat_ket_pengantar', 'view_surat_ket_pengantar', 'admin_surat_ket_pengantar', 'download_surat_ket_pengantar', 'S-01', NULL, 0, 0, 1, 1, 1, 'DAY', 0),
(2, 'Keterangan Penduduk', 'surat_ket_penduduk', 'view_surat_ket_penduduk', 'admin_surat_ket_penduduk', 'download_surat_ket_penduduk', 'S-02', NULL, 0, 0, 1, 1, 1, 'MONTH', 0),
(3, 'Biodata Penduduk', 'surat_bio_penduduk', 'view_surat_bio_penduduk', 'admin_surat_bio_penduduk', 'download_surat_bio_penduduk', 'S-03', 'f-1.01.php', 0, 0, 1, 0, 1, 'MONTH', 0),
(4, 'Keterangan Pindah Penduduk', 'surat_ket_pindah_penduduk', 'view_surat_ket_pindah_penduduk', 'admin_surat_ket_pindah_penduduk', 'download_surat_ket_pindah_penduduk', 'S-04', 'f-1.08.php,f-1.25.php', 0, 0, 1, 1, 1, 'MONTH', 0),
(5, 'Keterangan Jual Beli', 'surat_ket_jual_beli', 'view_surat_ket_jual_beli', 'admin_surat_ket_jual_beli', 'download_surat_ket_jual_beli', 'S-05', NULL, 0, 0, 1, 1, 1, 'MONTH', 0),
(6, 'Pengantar Surat Keterangan Catatan Kepolisian', 'surat_ket_catatan_kriminal', 'view_surat_ket_catatan_kriminal', 'admin_surat_ket_catatan_kriminal', 'download_surat_ket_catatan_kriminal', 'S-06', NULL, 0, 0, 1, 1, 1, 'WEEK', 0),
(7, 'Keterangan KTP dalam Proses', 'surat_ket_ktp_dalam_proses', 'view_surat_ket_ktp_dalam_proses', 'admin_surat_ket_ktp_dalam_proses', 'download_surat_ket_ktp_dalam_proses', 'S-08', NULL, 0, 0, 1, 0, 1, 'WEEK', 0),
(8, 'Keterangan Beda Identitas', 'surat_ket_beda_nama', 'view_surat_ket_beda_nama', 'admin_surat_ket_beda_nama', 'download_surat_ket_beda_nama', 'S-09', NULL, 0, 0, 1, 0, 1, 'MONTH', 0),
(9, 'Keterangan Bepergian / Jalan', 'surat_jalan', 'view_surat_jalan', 'admin_surat_jalan', 'download_surat_jalan', 'S-10', NULL, 0, 0, 1, 1, 1, 'WEEK', 0),
(10, 'Keterangan Kurang Mampu', 'surat_ket_kurang_mampu', 'view_surat_ket_kurang_mampu', 'admin_surat_ket_kurang_mampu', 'download_surat_ket_kurang_mampu', 'S-11', NULL, 0, 0, 1, 1, 1, 'MONTH', 0),
(11, 'Pengantar Izin Keramaian', 'surat_izin_keramaian', 'view_surat_izin_keramaian', 'admin_surat_izin_keramaian', 'download_surat_izin_keramaian', 'S-12', NULL, 0, 0, 1, 1, 1, 'MONTH', 0),
(12, 'Pengantar Laporan Kehilangan', 'surat_ket_kehilangan', 'view_surat_ket_kehilangan', 'admin_surat_ket_kehilangan', 'download_surat_ket_kehilangan', 'S-13', NULL, 0, 0, 1, 1, 1, 'WEEK', 0),
(13, 'Keterangan Usaha', 'surat_ket_usaha', 'view_surat_ket_usaha', 'admin_surat_ket_usaha', 'download_surat_ket_usaha', 'S-14', NULL, 0, 0, 1, 1, 1, 'MONTH', 0),
(14, 'Keterangan JAMKESOS', 'surat_ket_jamkesos', 'view_surat_ket_jamkesos', 'admin_surat_ket_jamkesos', 'download_surat_ket_jamkesos', 'S-15', NULL, 0, 0, 1, 0, 1, 'MONTH', 0),
(15, 'Keterangan Domisili Usaha', 'surat_ket_domisili_usaha', 'view_surat_ket_domisili_usaha', 'admin_surat_ket_domisili_usaha', 'download_surat_ket_domisili_usaha', 'S-16', NULL, 0, 0, 1, 1, 1, 'WEEK', 0),
(16, 'Keterangan Kelahiran', 'surat_ket_kelahiran', 'view_surat_ket_kelahiran', 'admin_surat_ket_kelahiran', 'download_surat_ket_kelahiran', 'S-17', 'f-kelahiran.php', 0, 0, 1, 0, 1, 'MONTH', 0),
(17, 'Permohonan Akta Lahir', 'surat_permohonan_akta', 'view_surat_permohonan_akta', 'admin_surat_permohonan_akta', 'download_surat_permohonan_akta', 'S-18', NULL, 0, 0, 1, 1, 1, 'DAY', 0),
(18, 'Pernyataan Belum Memiliki Akta Lahir', 'surat_pernyataan_akta', 'view_surat_pernyataan_akta', 'admin_surat_pernyataan_akta', 'download_surat_pernyataan_akta', 'S-19', NULL, 0, 0, 1, 0, 1, 'MONTH', 0),
(19, 'Permohonan Duplikat Kelahiran', 'surat_permohonan_duplikat_kelahiran', 'view_surat_permohonan_duplikat_kelahiran', 'admin_surat_permohonan_duplikat_kelahiran', 'download_surat_permohonan_duplikat_kelahiran', 'S-20', NULL, 0, 0, 1, 0, 1, 'MONTH', 0),
(20, 'Keterangan Kematian', 'surat_ket_kematian', 'view_surat_ket_kematian', 'admin_surat_ket_kematian', 'download_surat_ket_kematian', 'S-21', 'f-2.29.php', 0, 0, 1, 0, 1, 'MONTH', 0),
(21, 'Keterangan Lahir Mati', 'surat_ket_lahir_mati', 'view_surat_ket_lahir_mati', 'admin_surat_ket_lahir_mati', 'download_surat_ket_lahir_mati', 'S-22', NULL, 0, 0, 1, 0, 1, 'MONTH', 0),
(22, 'Keterangan Untuk Nikah (N-1 s/d N-7)', 'surat_ket_nikah', 'view_surat_ket_nikah', 'admin_surat_ket_nikah', 'download_surat_ket_nikah', 'S-23', NULL, 0, 0, 1, 0, 1, 'MONTH', 0),
(23, 'Keterangan Pergi Kawin', 'surat_ket_pergi_kawin', 'view_surat_ket_pergi_kawin', 'admin_surat_ket_pergi_kawin', 'download_surat_ket_pergi_kawin', 'S-30', NULL, 0, 0, 1, 0, 1, 'MONTH', 0),
(24, 'Keterangan Wali Hakim', 'surat_ket_wali_hakim', 'view_surat_ket_wali_hakim', 'admin_surat_ket_wali_hakim', 'download_surat_ket_wali_hakim', 'S-32', NULL, 0, 0, 1, 0, 1, 'MONTH', 0),
(25, 'Permohonan Duplikat Surat Nikah', 'surat_permohonan_duplikat_surat_nikah', 'view_surat_permohonan_duplikat_surat_nikah\n\n', '', '', 'S-33', NULL, 0, 0, 1, 0, 1, 'MONTH', 0),
(26, 'Permohonan Cerai', 'surat_permohonan_cerai', '0', '', '', 'S-34', NULL, 0, 0, 1, 0, 1, 'M', 0),
(27, 'Keterangan Pengantar Rujuk/Cerai', 'surat_ket_rujuk_cerai', '0', '', '', 'S-35', NULL, 0, 0, 1, 0, 1, 'M', 0),
(28, 'Permohonan Kartu Keluarga', 'surat_permohonan_kartu_keluarga', '0', '', '', 'S-36', 'f-1.15.php,f-1.01.php', 0, 0, 1, 0, 1, 'M', 0),
(29, 'Domisili Usaha Non-Warga', 'surat_domisili_usaha_non_warga', '0', '', '', 'S-37', NULL, 0, 0, 1, 0, 1, 'M', 0),
(30, 'Keterangan Beda Identitas KIS', 'surat_ket_beda_identitas_kis', '0', '', '', 'S-38', NULL, 0, 0, 1, 0, 1, 'M', 0),
(32, 'Pernyataan Penguasaan Fisik Bidang Tanah (SPORADIK)', 'surat_sporadik', '0', '', '', 'S-40', NULL, 0, 0, 1, 0, 1, 'M', 0),
(33, 'Permohonan Perubahan Kartu Keluarga', 'surat_permohonan_perubahan_kartu_keluarga', '0', '', '', 'S-41', 'f-1.16.php,f-1.01.php', 0, 0, 1, 0, 1, 'M', 0),
(34, 'Non Warga', 'surat_non_warga', '0', '', '', '', NULL, 0, 0, 2, 0, 1, 'M', 0),
(35, 'Keterangan Domisili', 'surat_ket_domisili', '0', '', '', 'S-41', NULL, 0, 0, 1, 0, 1, 'M', 0),
(36, 'Keterangan Penghasilan Orangtua', 'surat_ket_penghasilan_orangtua', '0', '', '', 'S-42', NULL, 0, 0, 1, 0, 1, 'M', 0),
(37, 'Pengantar Permohonan Penerbitan Buku Pas Lintas', 'surat_permohonan_penerbitan_buku_pas_lintas', '0', '', '', 'S-43', NULL, 0, 0, 1, 0, 1, 'M', 0),
(38, 'Keterangan Penghasilan Ayah', 'surat_ket_penghasilan_ayah', '0', '', '', 'S-44', NULL, 0, 0, 1, 0, 1, 'M', 0),
(39, 'Keterangan Penghasilan Ibu', 'surat_ket_penghasilan_ibu', '0', '', '', 'S-45', NULL, 0, 0, 1, 0, 1, 'M', 0),
(40, 'Perintah Perjalanan Dinas', 'surat_perintah_perjalanan_dinas', '0', '', '', 'S-46', NULL, 0, 0, 1, 0, 1, 'M', 0),
(41, 'Kuasa', 'surat_kuasa', '0', '', '', 'S-47', NULL, 0, 0, 1, 0, 1, 'M', 0),
(42, 'Keterangan Kepemilikan Kendaraan', 'surat_ket_kepemilikan_kendaraan', '0', '', '', 'S-48', NULL, 0, 0, 1, 0, 1, 'M', 0),
(43, 'Keterangan Kepemilikan Tanah', 'surat_ket_kepemilikan_tanah', '0', '', '', 'S-49', NULL, 0, 0, 1, 1, 1, 'M', 0);
...
INSERT INTO `syarat_surat` (`ref_syarat_id`, `ref_syarat_nama`) VALUES
...
INSERT INTO `text_berjalan` (`id`, `isi`) VALUES
(2, 'nm');
...
ALTER TABLE `penerima`
  ...
  ADD KEY `id_program` (`id_program`,`id`),
  ADD KEY `id` (`id`);
...
--
ALTER TABLE `aparat`
  MODIFY `pamong_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `budaya`
  MODIFY `id_budaya` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `covid_pantau`
--
ALTER TABLE `covid_pantau`
  MODIFY `id_pantau` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `covid_pemudik`
--
ALTER TABLE `covid_pemudik`
  MODIFY `id_terdata` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `dusun`
  MODIFY `id_dusun` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `pesankeluar`
  MODIFY `id_pesankeluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `rw`
  MODIFY `id_rw` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `syarat_surat`
  MODIFY `ref_syarat_id` int(1) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
