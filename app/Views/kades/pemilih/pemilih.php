        ...
        <div class="card-box table-responsive">
          ...
          <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tbody>
              ...
              <?php $query   = $db->query('SELECT penduduk.*,kk.no_kk,dusun.namadusun,rw.rw,rt.rt,pendidikan_kk.nama_pendidikan_kk,pekerjaan.nama_pekerjaan from penduduk JOIN dusun ON dusun.id_dusun = penduduk.id_dusun JOIN rw ON rw.id_rw = penduduk.id_rw JOIN rt ON rt.id_rt = penduduk.id_rt JOIN pendidikan_kk ON pendidikan_kk.id_pendidikan_kk = penduduk.id_pendidikan_kk JOIN pekerjaan ON pekerjaan.id_pekerjaan = penduduk.id_pekerjaan JOIN kk ON kk.id_kk = penduduk.id_kk Where YEAR(curdate()) - YEAR(penduduk.tanggallahir) >= 17');
