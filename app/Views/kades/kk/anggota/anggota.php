                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <select name="nama" id="nama" class="form-control" data-toggle="select2">
                            ...
                            <?php $query   = $db->query('SELECT * from penduduk Where id NOT IN(SELECT id FROM kk)  AND id_kk = 0');
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <select name="hubungan" id="hubungan" class="form-control" data-toggle="select2">
                            <option value="">Pilih </option>
              ...
              <?php foreach ($keluarga as $p) : ?>
                ...
                <tr>
                  ...
                  <td style="vertical-align: middle;">
                    ...
                    <?php if ($p['kk_level'] != '1') {
                    ?>
                      <a href="<?php echo base_url('edithubungan/' . $p['id']); ?>"><button type="button" class="btn btn-dark btn-xs waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Hubungan">
                          <i class="icon-link"></i>
                        </button></a>
