        ...
        <div class="card-box table-responsive">
          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <?php $query   = $db->query('SELECT * FROM surat_tidakmampu where id_permohonan =' . $permohonansurat['id_permohonan']);
                  $results = $query->getResultArray();
                  foreach ($results as $m) : ?>
                    <div class="row">
                      <div class="col-12">
                        <h3 class="font-w300" style="font-size: 20px;"> Berdasarkan pengantar dari RT/RW setempat dan data yang ada benar bahwa yang bersangkutan Penduduk Desa <?= $logo['nama_desa']; ?> dan : <br /><br />
                          <center>
                            <h4 class="font-w300" style="font-size: 20px; font-weight: bold;"> == yang bersangkutan tergolong keluarga yang tidak mampu (berpenghasilan rendah) karena tidak mempunyai penghasilan tetap ==</h4>

                          </center>
                          <br><br>
                          <h3 class="font-w300" style="font-size: 20px;"> Surat Keterangan ini dipergunakan untuk : <?= $m['keperluan']; ?> <br> <br>
                            Demikian keterangan ini, untuk digunakan sebagaimana mestinya. Orang tersebut di atas adalah benar-benar warga Desa <?= $logo['nama_desa']; ?> dan menurut data kami tidak pernah terlibat perkara Polisi dan beradat istiadat baik.
                          </h3>
                        <?php endforeach; ?>
