          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <div class="row">
                    ...
                    <div class="col-7">
                      <?php $query   = $db->query('SELECT * FROM surat_usaha where id_permohonan =' . $permohonansurat['id_permohonan']);
                  ...
                  <div class="row">
                    <div class="col-12">
                      <h3 class="font-w300" style="font-size: 20px;">Orang tersebut adalah benar-benar warga Desa <?= $logo['nama_desa']; ?> dengan data seperti di atas, yang memiliki usaha <?= $m['nama_usaha']; ?>.
