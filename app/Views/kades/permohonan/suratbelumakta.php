          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <div class="row">
                    ...
                    <label class="col-11">
                      <h3 class="font-w300" style="font-size: 20px;">Dengan Orang Tua : </h3>
                    </label>
                  </div>
                  <div class="row">
                    <label class="col-1">
                    ...
                    <div class="col-6">
                      ...
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp;
                        <?= $permohonansurat['nama_ayah']; ?>
                      </h3>
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp;
                        <?= $permohonansurat['ayah_nik']; ?>
                      </h3>
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp;
                        <?= $permohonansurat['nama_ibu']; ?>
                      </h3>
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp;
                        <?= $permohonansurat['ibu_nik']; ?>
                      </h3>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-12">
                      <h3 class="font-w300" style="font-size: 20px; padding:2px">Adalah benar-benar warga Desa <?= $logo['nama_desa']; ?> dan belum pernah memiliki Akta Kelahiran.
                      </h3>
                      <br>
                      <h3 class="font-w300" style="font-size: 20px;">
