        ...
        <div class="card-box table-responsive">
          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <div class="row">
                    <div class="col-12">
                      <h3 class="font-w300" style="font-size: 20px;">Yang bertanda tangan di bawah ini :</h3>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <label class="col-4">
                      ...
                      <h3 class="font-w300" style="font-size: 20px;">Nik </h3>
                  ...
                  <div class="row">
                    ...
                    <label class="col-12">
                      <h3 class="font-w300" style="font-size: 20px;">Dengan ini memberi kuasa penuh kepada: </h3>
                    </label>

                  </div>

                  <?php $query   = $db->query('SELECT surat_kuasa.*,  pekerjaan.* FROM surat_kuasa JOIN pekerjaan ON pekerjaan.id_pekerjaan = surat_kuasa.id_pekerjaan where id_permohonan =' . $permohonansurat['id_permohonan']);
                  ...
                  foreach ($results as $m) : ?>
                    <div class="row">
                      ...
                      <div class="col-7">
                        <h3 class="font-w300" style="font-size: 20px; font-weight: bold;"> : &nbsp; <?= $m['nama_penerima']; ?> </h3>
                        <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['nik_penerima']; ?> </h3>
                        <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['tempatlahirpenerima']; ?> /
                          <?php
                          $dt = explode('-', $m['tgllahirpenerima']);
                          if ($dt[1] == '01') {
                            $month = 'Januari';
                          }
                          if ($dt[1] == '02') {
                          ...
                          ?> </h3>
                        <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?php
                                                                                  $tanggal = new DateTime($m['tgllahirpenerima']);
                                                                                  // tanggal hari ini
                                                                                  $today = new DateTime('today');
                                                                                  ...
                                                                                  $y = $today->diff($tanggal)->y;
                                                                                  ?><?= $y; ?> Tahun </h3>
                        <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?php echo $m['jk_penerima']; ?>

                        </h3>
                        <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['nama_pekerjaan']; ?> </h3>
                        <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['alamat_penerima']; ?> Desa <?= $m['desa_penerima']; ?> Kec. <?= $m['kec_penerima']; ?> Kab. <?= $m['kab_penerima']; ?> Provinsi <?= $m['prov_penerima']; ?> </h3>
                    ...
                    <div class="row">
                      ...
                      <label class="col-4">
                        <h3 class="font-w300" style="font-size: 20px;">Untuk Keperluan </h3>

                      </label>

                      <div class="col-7">
                        <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['keperluan']; ?> </h3>
                      </div>
                      <label class="col-12">
                        <h3 class="font-w300" style="font-size: 20px;"> Demikianlah surat kuasa ini saya buat, agar dapat digunakan sebagaimana mestinya.
                        </h3>
