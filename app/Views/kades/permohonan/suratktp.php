    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box">
          ...
          <h4 class="page-title">Data Ktp Dalam Proses</h4>
        </div>
      </div>
    </div>
    <!-- end page title -->
        ...
        <div class="card-box table-responsive">
          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <div class="row">
                    <div class="col-12">
                      <h3 class="font-w300" style="font-size: 20px;">Orang tersebut di atas adalah benar-benar warga Desa <?= $logo['nama_desa']; ?> yang saat ini Kartu Tanda Penduduk sedang dalam proses.
                      </h3>
                      <h3 class="font-w300" style="font-size: 20px;">
