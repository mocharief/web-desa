          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <div class="row">
                    ...
                    <div class="col-7">
                      <?php $query   = $db->query('SELECT * FROM surat_kriminal where id_permohonan =' . $permohonansurat['id_permohonan']);
                      $results = $query->getResultArray();
                      foreach ($results as $m) : ?>
                        <h3 class="font-w300" style="font-size: 20px;"> : &nbsp;
                          Sebagai pengantar untuk mendapatkan SKCK yang akan dipergunakan untuk <?= $m['keperluan']; ?>
                        </h3>
                      <?php endforeach; ?>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <h3 class="font-w300" style="font-size: 20px;"> Orang tersebut di atas adalah benar-benar warga Desa <?= $logo['nama_desa']; ?> dan menurut data kami tidak pernah terlibat perkara Polisi dan beradat istiadat baik.
