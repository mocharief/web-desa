        ...
        <div class="card-box table-responsive">
          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <div class="col-12">
                    <h3 class="font-w300" style="font-size: 20px; padding:2px">Yang namanya tersebut di atas memang benar warga kami yang akan menikah di KUA Kecamataan <?= $logo['nama_kecamatan']; ?>, <?= $logo['nama_kabupaten']; ?>. Berhubung orang tersebut tidak memiliki Wali Nasab, kami mohon dengan hormat Ibu/Bapak Kepala KUA <?= $logo['nama_kecamatan']; ?> agar berkenan menjadi Wali.
                    </h3>
                    <h3 class="font-w300" style="font-size: 20px;">
