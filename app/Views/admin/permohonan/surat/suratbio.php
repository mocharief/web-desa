          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <div class="row">
                    ...
                    <label class="col-11">
                      <h3 class="font-w300" style="font-size: 20px; font-weight: bolder;">I. DATA PENDUDUK</h3>
                    </label>
                  ...
                  <div class="row">
                    ...
                    <label class="col-4">
                      ...
                      <h3 class="font-w300" style="font-size: 20px;">Status Kawin </h3>
                      <h3 class="font-w300" style="font-size: 20px;">Golongan Darah </h3>
                      <h3 class="font-w300" style="font-size: 20px;">Pendidikan Terakhir </h3>
                    ...
                    <div class="col-7">
                      ...
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp;
                        <?php if ($permohonansurat['status_kawin'] == 1) {
                          echo 'Belum Kawin';
                        } ?> <?php if ($permohonansurat['status_kawin'] == 2) {
                                echo 'Kawin';
                              } ?> <?php if ($permohonansurat['status_kawin'] == 3) {
                                      echo 'Cerai Hidup';
                                    } ?> <?php if ($permohonansurat['status_kawin'] == 4) {
                                            echo 'Cerai Mati';
                                          } ?>
                      </h3>
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $permohonansurat['nama_golongan']; ?> </h3>
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $permohonansurat['nama_pendidikan_kk']; ?> </h3>
                  ...
                  <div class="row">
                    ...
                    <label class="col-11">
                      <h3 class="font-w300" style="font-size: 20px; font-weight: bolder;">II. DATA Orang Tua</h3>
                    </label>
                  ...
                  <div class="row">
                    ...
                    <label class="col-4">
                      ...
                      <h3 class="font-w300" style="font-size: 20px;">NIK Ayah </h3>
                      <h3 class="font-w300" style="font-size: 20px;">Nama Ibu </h3>
                      <h3 class="font-w300" style="font-size: 20px;">NIK Ibu </h3>
                    </label>
                    <div class="col-7">
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $permohonansurat['nama_ayah']; ?> </h3>
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $permohonansurat['ayah_nik']; ?> </h3>
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $permohonansurat['nama_ibu']; ?> </h3>
                      <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $permohonansurat['ibu_nik']; ?> </h3>
                    </div>
                  </div>
                  <br> <br><br>
