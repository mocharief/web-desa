        ...
        <div class="card-box table-responsive">
          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <?php $query   = $db->query('SELECT * FROM surat_kehilangan where id_permohonan =' . $permohonansurat['id_permohonan']);
                  ...
                  foreach ($results as $m) : ?>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <h3 class="font-w300" style="font-size: 20px;">Orang tersebut adalah benar-benar warga Desa <?= $logo['nama_desa']; ?> dengan data seperti di atas.</h3>
                        <h3 class="font-w300" style="font-size: 20px;">
                          Orang tersebut telah melapor dan mengaku telah kehilangan <?= $m['barang']; ?> sebagai berikut:
                        </h3>
                    ...
                    <div class="row">
                      ...
                      <label class="col-4">
                        <h3 class="font-w300" style="font-size: 20px;">Rincian </h3>
                      </label>
                      <div class="col-7">

                        <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['rincian_barang']; ?> </h3>
                        </h3>
