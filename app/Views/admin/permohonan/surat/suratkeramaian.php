          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <div class="row">
                    ...
                    <div class="col-7">
                      <?php $query   = $db->query('SELECT * FROM surat_izin_keramaian where id_permohonan =' . $permohonansurat['id_permohonan']);
                      $results = $query->getResultArray();
                      foreach ($results as $m) : ?>
                        <h3 class="font-w300" style="font-size: 20px;"> : &nbsp;
                          Sebagai pengantar untuk mendapatkan Surat Izin Keramaian berupa <?= $m['jenis_acara']; ?> mulai tanggal <?php
