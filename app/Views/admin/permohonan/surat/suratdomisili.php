        ...
        <div class="card-box table-responsive">
          ...
          <div class="row">
           ...
           <br> <br> ";
                  ...
                  <?php $query   = $db->query('SELECT * FROM surat_domisili_usaha where id_permohonan =' . $permohonansurat['id_permohonan']);
                  ...
                  foreach ($results as $m) : ?>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <h3 class="font-w300" style="font-size: 20px;">Orang tersebut di atas adalah benar-benar warga Desa <?= $logo['nama_desa']; ?> yang memiliki usaha <?= $m['nama_usaha']; ?> di <?= $m['alamat_usaha']; ?>, Desa <?= $logo['nama_desa']; ?>, Kecamatan <?= $logo['nama_kecamatan']; ?>, Kabupaten <?= $logo['nama_kabupaten']; ?>.
