              ...
              <?php foreach ($permohonansurat as $p) : ?>
                <tr>
                  ...
                  <td style="vertical-align: middle;">
                    <?php if ($p['status'] == '1') {
                    ?>
                      <a href="<?php echo base_url('periksapermohonan/' . $p['id_permohonan']); ?>"><button type="button" class="btn btn-info btn-xs waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Klik Untuk Memeriksa">
                          <span><i class="dripicons-loading"></i> </span> Sedang Diperiksa
                        </button></a>
                    <?php } else if ($p['status'] == '2') {
                    ?>
                      <a href=""><button type="button" class="btn btn-purple btn-xs waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Klik Jika Sudah ditanda tangani" disabled>
                    ...
                    ?>
                      ...
                      ?>
                        <a href="<?= base_url('aktaselesai/update/' . $p['id_permohonan']); ?>"><button type="button" class="btn btn-warning btn-xs waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Klik Jika akta Sudah Selesai">
                            <span><i class="dripicons-thumbs-up"></i> </span> Akta Dalam Proses
                          </button></a>
                      <?php } else {
                      ?>
                      ...
                      <?php  }  ?>
                      <a href="<?= base_url('' . $p['url_admin'] . '/' . $p['id_permohonan']); ?>"><button type=" button" class="btn btn-success btn-xs waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="View Permohonan">
                    ...
                    ?>
                      ...
                      <form action="<?= base_url('deletepermohonan/' . $p['id_permohonan']); ?>" method="post" class="d-inline">
                        <?= csrf_field(); ?>
