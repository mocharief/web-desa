  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box">
          ...
          <h4 class="page-title">Data Kategori UMKM</h4>
        </div>
      </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
            ...
            <tbody>
              ...
              <?php foreach ($kat as $p) : ?>
                <tr>
                  ...
                  <td style="vertical-align: middle;"> <a href="<?php echo base_url('editkatumkm/' . $p['id_kat']); ?>"><button type="button" class="btn btn-success btn-xs waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Data">
                        <i class="fas fa-edit"></i>
                      </button></a>
                    <form action="<?= base_url('deletekatumkm/' . $p['id_kat']); ?>" method="post" class="d-inline">
                      <?= csrf_field(); ?>
      ...
      <div class="col-md-4">
        ...
        <div class="card-box">
          <form action="<?php echo base_url('/admin/umkm/tambahkat'); ?>" method="post" class="form-horizontal">
            <?= csrf_field(); ?>
            <div class="row">
