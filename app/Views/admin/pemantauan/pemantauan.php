        ...
        <div class="card-box">
          <form action="<?php echo base_url('admin/pemantauan/simpan'); ?>" method="post" class="form-horizontal">
            ...
            <div class="row">
              ...
              ?>
              <h4 class="header-title mb-2">Form Pemantauan <br> Tanggal <span id="tanggalwaktu"></span></h4>
                ...
                <div class="col-12">
                  <select name="nama" id="nama" class="form-control" data-toggle="select2" onchange='changeValue(this.value)'>
                    ...
                    <?php foreach ($pendataan as $d) : ?>
                      ...
                      <?php $jsArray .= "prdName['" . $d['id'] . "'] = {tgl_datang:'" . addslashes($dt[2] . ' ' . $month . ' ' . $dt[0]) . "'};\n"; ?>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                <label for="inputEmail3" class="col-12 col-form-label">Tanggal Tiba</label>
                <div class="col-12">
                  <input type="text" class="form-control" id="tgl_datang" name="tgl_datang" readonly>
                </div>
              </div>
...
<script type="text/javascript">
  ...
  function changeValue(id) {
    document.getElementById('tgl_datang').value = prdName[id].tgl_datang;
