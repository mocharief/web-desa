    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="card-box table-responsive">
          ...
          <a href="<?php echo base_url('tambahrt/' . $rw['id_rw']); ?>">
              ...
              <?php foreach ($rt as $p) : ?>
                <tr>
                  ...
                  <td style="vertical-align: middle;">
                    <a href="<?php echo base_url('editrt/' . $p['id_rt']); ?>"><button type="button" class="btn btn-success btn-xs waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit Data">
                        <i class="fas fa-edit"></i>
                      </button>
                    </a>
                    <form action="<?= base_url('deletert/' . $p['id_rt']); ?>" method="post" class="d-inline">
                      <?= csrf_field(); ?>
                      <input type="hidden" name="_method" value="DELETE">
                      <input type="hidden" class="form-control" id="id_rw" name="id_rw" value="<?= $p['id_rw']; ?>" required>
                  ...
                  <td style="vertical-align: middle;"> <?= $p['kepala_rt']; ?></td>
