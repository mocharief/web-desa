...
<div class="content">
  ...
  <div class="container-fluid">
    ...
    <form action="<?php echo base_url('/admin/wilayah/simpandusun'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
      <?= csrf_field(); ?>
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="card-box">
            ...
            <div class="form-group row">
              <label for="inputEmail3" class="col-3 col-form-label">Kepala Dusun</label>
              <div class="col-9">
