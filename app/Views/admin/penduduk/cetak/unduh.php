...
<body>
  <div class="content">
    ...
    <div class="container-fluid">
      ...
      header("Content-Disposition: attachment; filename=Data Penduduk Desa " . $logo['nama_desa'] . ".xls");
	...
	<center>
    	<h4></h4>
		<h4>Data Penduduk Desa <?= $logo['nama_desa']; ?></h4>
    	<h5><?= $logo['alamat_kantor']; ?></h5>
	</center>
          ...
          <thead style="background-color: aquamarine;">
            <tr>
              ...
              <th style="width: 2%;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center; vertical-align: middle; ">No</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle; ">No KK</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Nama</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">NIK</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Alamat</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Dusun</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Rw</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Rt</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Jenis Kelamin</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Tempat Lahir</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Tanggal Lahir</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Umur</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Agama</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Pendidikan (Dlm KK)</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Pekerjaan</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Kawin</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Hub. Keluarga</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Nama Ayah</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Nama Ibu</th>
              <th style="text-transform: uppercase; font-size: xx-small;padding: 5px; text-align: center; vertical-align: middle;">Status</th>
            </tr>
          </thead>
          ...
          <tbody>
            ...
            <?php foreach ($penduduk as $p) : ?>
              <tr>
                ...
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small;  padding: 5px; text-align: center;color: black;"> <?= $p['rt']; ?></td>
                ...
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;"> <?= $p['tempatlahir']; ?></td>
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;"> <?php
                ...
                <td style="vertical-align: middle; text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;"> <?php
                                                                                                                                                    ...
                                                                                                                                                    ?> <?= $y; ?> Tahun</td>
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;"> <?= $p['agama']; ?></td>
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;"> <?= $p['nama_pendidikan_kk']; ?></td>
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;"> <?= $p['nama_pekerjaan']; ?></td>
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;">
                ...
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;"> <?= $p['nama_hubungan']; ?></td>
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;"> <?= $p['nama_ayah']; ?></td>
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;"> <?= $p['nama_ibu']; ?></td>
                <td style="vertical-align: middle;text-transform: uppercase; font-size: xx-small; padding: 5px; text-align: center;color: black;">
                  <?php if ($p['status'] == 1) {
                    echo 'Tetap';
                  } ?>
