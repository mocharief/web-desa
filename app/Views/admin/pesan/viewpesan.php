      ...
      <div class=" row">
        ...
        <div class="col-md-12">
          <div class="card-box">
            ...
            <a href="<?php echo base_url('balaspesan/' . $pesan['id_pesan']); ?>"><button type="button" class="btn btn-info btn-sm waves-effect waves-light">
                <i class="fas fa-comment"></i> &nbsp; Balas Pesan
              </button>
            </a>
            <br> <br>
