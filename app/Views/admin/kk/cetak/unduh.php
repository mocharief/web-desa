...
<body>
  <div class="content">
    ...
    <div class="container-fluid">
      ...
      header("Content-Disposition: attachment; filename=Data Kepala Keluarga Desa " . $logo['nama_desa'] . ".xls");
	...
	<center>
    	<h4></h4>
		<h4>Data Kepala Keluarga Desa <?= $logo['nama_desa']; ?></h4>
            ...
            <?php foreach ($kk as $p) : ?>
              <tr>
                ...
                foreach ($results as $l) : ?>
                  <td style="vertical-align: middle;text-transform: uppercase; font-size: x-small;  padding: 5px; text-align: center;color: black;"> <?php echo  "'" . (string)$l; ?></td>
                <?php endforeach; ?>
