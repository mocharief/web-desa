  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-3 col-sm-6">
        <button type="button" class="btn btn-success btn-sm waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal" style="width: 100%;"> <i class="fas fa-plus"></i> &nbsp; Penduduk Kepala Keluarga</button>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select name="nama" id="nama" class="form-control" data-toggle="select2" required>
                          ...
                          <?php $query   = $db->query('SELECT * from penduduk Where id NOT IN(SELECT id FROM kk) AND kk_level = 1 AND id_kk = 0 AND kddesa=' . $kddesa);
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="field-3" name="no_kk" placeholder="No KK" maxlength="17" required>
                      </div>
                    </div>
                  </div>
      ...
      <div class="col-md-3 col-sm-6">
        <button type="button" class="btn btn-purple btn-sm waves-effect waves-light" data-toggle="modal" data-target="#cetak" style="width: 100%;"> <i class="fas fa-print"></i> &nbsp; Cetak</button>
        <div id="cetak" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <form action="<?php echo base_url('admin/kk/cetaksemua'); ?>" method="post" class="form-horizontal" target="_blank">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                  <h4 class="modal-title">Cetak Data Kepala Keluarga</h4>
                </div>
                <div class="modal-body">
      ...
      <div class="col-md-3 col-sm-6">
        ...
        <div id="unduh" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <form action="<?php echo base_url('admin/kk/unduhsemua'); ?>" method="post" class="form-horizontal" target="_blank">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                  <h4 class="modal-title">Unduh Data Kepala Keluarga</h4>
                </div>
                <div class="modal-body">
                ...
                <tr>
                  ...
                  <td style="vertical-align: middle;">
                    ...
                    <form action="<?= base_url('deletekk/' . $p['id_kk']); ?>" method="post" class="d-inline">
                      ...
                      <input type="hidden" name="id_kk" value="<?= $p['id_kk']; ?>">
