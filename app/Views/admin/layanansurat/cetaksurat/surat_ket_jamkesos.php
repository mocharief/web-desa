...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Pembuatan Surat Keterangan JAMKESOS</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="col-xl-12">
            <form action="<?php echo base_url('/admin/layanansurat/simpanjamkesos'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <?= csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" id="no_jamkesos" name="no_jamkesos" required placeholder="No JAMKESOS" required value="<?= old('no_jamkesos'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
