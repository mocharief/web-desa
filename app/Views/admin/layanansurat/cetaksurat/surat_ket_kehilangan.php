...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Pembuatan Surat Keterangan Kehilangan Barang</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="col-xl-12">
            <form action="<?php echo base_url('/admin/layanansurat/simpankehilangan'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <?= csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Barang yang Hilang</label>
                                <div class="col-9">
                                    <input type="text" class="form-control" id="barang" name="barang" required placeholder="Barang yang Hilang" required value="<?= old('barang'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <textarea type="text" rows="4" class="form-control" id="rincian_barang" name="rincian_barang" required placeholder="Rincian Barang"><?= old('rincian_barang'); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Rincian Kejadian</label>
                                <div class="col-9">
                                    <textarea type="text" rows="4" class="form-control" id="kejadian" name="kejadian" required placeholder="Rincian Kejadian"><?= old('kejadian'); ?></textarea>
                                </div>
                            </div>
