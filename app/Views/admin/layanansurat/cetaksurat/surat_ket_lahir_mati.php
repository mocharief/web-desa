...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Pembuatan Surat Permohonan Keterangan Lahir Mati</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="col-xl-12">
            <form action="<?php echo base_url('/admin/layanansurat/simpanlahirmati'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <?= csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <select name="pelapor" id="pelapor" class="form-control" required data-toggle="select2">
                                        <option>-- Pilih Nik / Nama Penduduk --</option>
                                        <?php
                                        foreach ($penduduk as $d) : ?>
