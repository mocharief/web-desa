...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Pembuatan Surat Keterangan Jual Beli</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="col-xl-12">
            <form action="<?php echo base_url('/admin/layanansurat/simpanjualbeli'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <?= csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" id="jenis_barang" name="jenis_barang" required value="<?= old('jenis_barang'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <textarea type="text" rows="4" class="form-control" id="rincian_barang" name="rincian_barang" required><?= old('rincian_barang'); ?></textarea>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label" style="font-size: larger;"><b>Data Pembeli</b></label>
                                <div class="col-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" id="nik_pembeli" name="nik_pembeli" required value="<?= old('nik_pembeli'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Nama Pembeli</label>
                                <div class="col-9">
                                    <input type="text" class="form-control" id="nama_pembeli" name="nama_pembeli" required value="<?= old('nama_pembeli'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Tempat / Tanggal Lahir Pembeli</label>
                                <div class="col-5">
                                    <input type="text" class="form-control" id="tempatlahirpembeli" name="tempatlahirpembeli" required value="<?= old('tempatlahirpembeli'); ?>">
                                </div>
                                <div class="col-4">
                                    <input type="date" class="form-control" id="tgllahirpembeli" name="tgllahirpembeli" required value="<?= old('tgllahirpembeli'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Jenis Kelamin Pembeli</label>
                                <div class="col-9">
                                    <select name="jkpembeli" id="jkpembeli" class="form-control" required autofocus>
                                        <option value="">Pilih Jenis Kelamin</option>
                                        <option <?php if (old('jkpembeli') == "Laki - Laki") {
                                                    echo 'selected';
                                                } ?> value="Laki - Laki">Laki - Laki
                                        </option>
                                        <option <?php if (old('jkpembeli') == "Perempuan") {
                                                    echo 'selected';
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <textarea type="text" rows="4" class="form-control" id="alamat_pembeli" name="alamat_pembeli" required><?= old('alamat_pembeli'); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Pekerjaan Pembeli</label>
                                <div class="col-9">
                                    <input type="text" class="form-control" id="pekerjaan_pembeli" name="pekerjaan_pembeli" required value="<?= old('pekerjaan_pembeli'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Keterangan</label>
                                <div class="col-9">
                                    <textarea type="text" rows="4" class="form-control" id="keterangan" name="keterangan" required><?= old('keterangan'); ?></textarea>
                                </div>
                            </div>
