...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Pembuatan Surat Izin Keramaian</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="col-xl-12">
            <form action="<?php echo base_url('/admin/layanansurat/simpankeramaian'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <?= csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Jenis Acara</label>
                                <div class="col-9">
                                    <input type="text" class="form-control" id="jenis_acara" name="jenis_acara" placeholder="Jenis Acara" required value="<?= old('jenis_acara'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
