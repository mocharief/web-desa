...
<div class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Pembuatan Surat Permohonan Akta Kelahiran</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="col-xl-12">
            <form action="<?php echo base_url('/admin/layanansurat/simpanakta'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                <?= csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card-box">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" id="nama_anak" name="nama_anak" required placeholder="Nama Anak" value="<?= old('nama_anak'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Tempat, Tanggal Lahir</label>
                                <div class="col-4">
                                    <input type="text" class="form-control" id="tempatlahiranak" name="tempatlahiranak" required placeholder="Tempat Lahir Anak" value="<?= old('tempatlahiranak'); ?>">
                                </div>
                                <div class="col-4">
                                    <input type="date" class="form-control" id="tgl_anak" name="tgl_anak" required placeholder="Tanggal Lahir Anak" value="<?= old('tgl_anak'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" id="harilahir" name="harilahir" required placeholder="Hari Lahir" value="<?= old('harilahir'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <textarea type="text" rows="4" class="form-control" id="alamatanak" name="alamatanak" required placeholder="Alamat Anak"><?= old('alamatanak'); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <select name="jkanak" id="jkanak" class="form-control" required autofocus>
                                        ...
                                        <option <?php if (old('jkanak') == "Laki - Laki") {
                                                    echo 'selected';
                                                } ?> value="Laki - Laki">Laki - Laki
                                        </option>
                                        <option <?php if (old('jkanak') == "Perempuan") {
                                                    echo 'selected';
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" id="nama_ayahanak" name="nama_ayahanak" required placeholder="Nama Ayah" value="<?= old('nama_ayahanak'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Nama Ibu</label>
                                <div class="col-9">
                                    <input type="text" class="form-control" id="nama_ibuanak" name="nama_ibuanak" required placeholder="Nama Ibu" value="<?= old('nama_ibuanak'); ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-3 col-form-label">Alamat Orang Tua</label>
                                <div class="col-9">
                                    <textarea type="text" rows="4" class="form-control" id="alamat_orangtua" name="alamat_orangtua" required placeholder="Alamat Orang Tua"><?= old('alamat_orangtua'); ?></textarea>
                                </div>
                            </div>
