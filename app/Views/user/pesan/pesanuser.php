                ...
                <?php foreach ($pesan as $p) : ?>
                    <tr>
                        ...
                        <td style="vertical-align: middle;">
                            ...
                            <a href="<?php echo base_url('lihatpesan/' . $p['id_pesankeluar']); ?>"><button type="button" class="btn btn-success btn-xs waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="" data-original-title="View">
