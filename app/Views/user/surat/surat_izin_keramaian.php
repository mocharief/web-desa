...
<div class="col-xl-9">
    <div class="card-box">
        <h3 class="mb-2">Layanan Mandiri Pembuatan Surat Pengantar Izin Keramaian</h3>
    ...
    <form action="<?php echo base_url('/user/surat/simpankeramaian'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <?= csrf_field(); ?>
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="jenis_acara" name="jenis_acara" required placeholder="Jenis Acara">
                        </div>
                    </div>
