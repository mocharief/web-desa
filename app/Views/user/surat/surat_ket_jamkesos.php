...
<div class="col-xl-9">
    <div class="card-box">
        <h3 class="mb-2">Layanan Mandiri Pembuatan Surat Keterangan JAMKESOS</h3>
    ...
    <form action="<?php echo base_url('/user/surat/simpanjamkesos'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <?= csrf_field(); ?>
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="no_jamkesos" name="no_jamkesos" required placeholder="No JAMKESOS">
                        </div>
                    </div>
