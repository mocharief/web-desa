          ...
          <div class="block-content">
           ...
           <br> <br> ";
            ...
            <div class="row">
              ...
              <label class="col-4">
                <h3 class="font-w300" style="font-size: 20px;">Surat Bukti diri </h3>
              </label>
              <div class="col-6">
            ...
            <div class="row">
              ...
              <label class="col-4">
                <h3 class="font-w300" style="font-size: 20px;">KTP </h3>
              </label>
              <div class="col-7">
              ...
              <label class="col-4">
                <h3 class="font-w300" style="font-size: 20px;">KK </h3>
              </label>
              <div class="col-6">
            ...
            <div class="row">
              ...
              <div class="col-7">
                <?php $query   = $db->query('SELECT * FROM surat_pengantar where id_permohonan =' . $permohonansurat['id_permohonan']);
