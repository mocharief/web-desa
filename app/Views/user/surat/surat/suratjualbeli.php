          ...
          <div class="col-12">
           ...
           <br> <br> ";
                    ...
                    <td width="75%" align="center">
                      ...
                      <h4 style="text-transform: uppercase;padding-top: 2px; font-size: 16px;"><?= $logo['alamat_kantor']; ?></h4>
                    </td>
                ...
                <div class="row">
                  ...
                  <div class="col-7">
                    ...
                    ?>
                    <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $y; ?> Tahun </h3>
                    </h3>
                ...
                <div class="row">
                  ...
                  <label class="col-4" style="font-size: 20px;">
                    <h3 class="font-w300">Pekerjaan </h3>
                  </label>
                  <div class="col-7">
                  ...
                  <label class="col-4">
                    <h3 class="font-w300" style="font-size: 20px;">Tempat Tinggal </h3>
                  </label>
                  <div class="col-7">
                  ...
                  <?php $query   = $db->query('SELECT * FROM surat_jualbeli where id_permohonan =' . $permohonansurat['id_permohonan']);
                  $results = $query->getResultArray();
                  foreach ($results as $m) : ?>
                    <label class="col-12">
                      <h3 class="font-w300" style="font-size: 20px;">Yang bersangkutan hendak menjual <?= $m['rincian_barang']; ?>. <?= $m['jenis_barang']; ?> tersebut tidak dalam sengketa dengan pihak lain sehingga dapat dijual kepada pihak kedua yaitu:</h3>
                    </label>
                ...
                <div class="row">
                  ...
                  <div class="col-7">
                    <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['nik_pembeli']; ?> </h3>
                    </h3>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7">
                    ...
                    <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['tempatlahirpembeli']; ?> /
                      <?php
                      $dt = explode('-', $m['tgllahirpembeli']);
                      if ($dt[1] == '01') {
                        $month = 'Januari';
                      }
                      if ($dt[1] == '02') {
                ...
                <div class="row">
                  ...
                  <div class="col-7">
                    <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['jkpembeli']; ?> </h3>
                    </h3>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-7">
                    <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['alamat_pembeli']; ?> </h3>
                    </h3>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-7">
                    <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['pekerjaan_pembeli']; ?> </h3>
                    </h3>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-7">
                    <h3 class="font-w300" style="font-size: 20px;"> : &nbsp; <?= $m['keterangan']; ?> </h3>
                    </h3>
                  </div>
                </div>
              <?php endforeach; ?>
              ...
              <div class="row">
                <div class="col-12">
                  <h3 class="font-w300" style="font-size: 20px;"> Demikian surat ini dibuat, untuk dipergunakan sebagaimana mestinya.</h3>
