        ...
        <div class="block">
          <div class="block-content">
           ...
           <br> <br> ";
            ...
            <?php $query   = $db->query('SELECT * FROM surat_jamkesos where id_permohonan =' . $permohonansurat['id_permohonan']);
            ...
            <div class="row">
              <div class="col-12">
                <h3 class="font-w300" style="font-size: 20px;">Orang tersebut adalah benar-benar warga Desa <?= $logo['nama_desa']; ?> dengan data seperti di atas, dari keluarga kurang mampu pemegang Kartu Peserta Jamkesos No. <?= $m['no_jamkesos']; ?>.
