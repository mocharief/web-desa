...
<div class="col-xl-9">
    <div class="card-box">
        <h3 class="mb-2">Layanan Mandiri Pembuatan Surat Keterangan Cerai</h3>
    ...
    <form action="<?php echo base_url('/user/surat/simpancerai'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <?= csrf_field(); ?>
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-3 col-form-label">Tanggal Cerai</label>
                        <div class="col-9">
                            <input type="date" class="form-control" id="tglcerai" name="tglcerai" required value="<?= old('tglcerai'); ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-3 col-form-label">Sebab - Sebab</label>
                        <div class="col-9">
                            <textarea type="text" rows="4" class="form-control" id="sebab" name="sebab" required placeholder="Sebab - Sebab"><?= old('sebab'); ?></textarea>
                        </div>
                    </div>
