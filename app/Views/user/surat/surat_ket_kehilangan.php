...
<div class="col-xl-9">
    <div class="card-box">
        <h3 class="mb-2">Layanan Mandiri Pembuatan Surat Laporan Kehilangan</h3>
    ...
    <form action="<?php echo base_url('/user/surat/simpankehilangan'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <?= csrf_field(); ?>
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="barang" name="barang" required placeholder="Barang yang Hilang">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <textarea type="text" rows="4" class="form-control" id="rincian_barang" name="rincian_barang" required placeholder="Rincian Barang"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-3 col-form-label">Rincian Kejadian</label>
                        <div class="col-9">
                            <textarea type="text" rows="4" class="form-control" id="kejadian" name="kejadian" required placeholder="Rincian Kejadian"></textarea>
                        </div>
                    </div>
