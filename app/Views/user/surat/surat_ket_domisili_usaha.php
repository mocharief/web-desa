...
<div class="col-xl-9">
    <div class="card-box">
        <h3 class="mb-2">Layanan Mandiri Pembuatan Surat Keterangan Domisili Usaha</h3>
    ...
    <form action="<?php echo base_url('/user/surat/simpandomisili'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <?= csrf_field(); ?>
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" id="namausaha" name="namausaha" required placeholder="Nama Usaha">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <textarea type="text" rows="4" class="form-control" id="alamat" name="alamat" required placeholder="Alamat"></textarea>
                        </div>
                    </div>
