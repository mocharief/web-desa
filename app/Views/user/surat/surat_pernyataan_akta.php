...
<div class="col-xl-9">
    <div class="card-box">
        <h3 class="mb-2">Layanan Mandiri Pembuatan Surat Keterangan Belum Punya Akta</h3>
    ...
    <form action="<?php echo base_url('/user/surat/simpanpernyataan'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <?= csrf_field(); ?>
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" value="<?php if ($user['sex'] == 1) {
                                                                                echo 'Laki - Laki';
                                                                            } ?><?php if ($user['sex'] == 2) {
                                                                                    echo 'Perempuan';
                                                                                } ?>" readonly>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input type="text" class="form-control" value="<?= $user['nama_pekerjaan']; ?>" readonly>
                        </div>
                    </div>
