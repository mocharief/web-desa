...
class Portofolio extends BaseController
{
	...
	public function index()
	{
		...
		$portofolio = $this->portofolioModel->paginate(2, 'portofolio');
		$makeup = $this->portofolioModel->paginate(2, 'makeup');
		$pager = $this->portofolioModel->pager;
		$recent = $this->portofolioModel->view();
		...
		$data = [
			...
			'db' => $db,
			'pager' => $pager,
			'activemenu' => $this->data['activemenu'] = 'my-portofolio',

		];

		return view('frontend/portofolio', $data);
	}
